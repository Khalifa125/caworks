...
export default function About() {
  ...
  return (
    <section className="bg-deep border-t border-rule px-6 md:px-8 lg:px-14 py-20 lg:py-[120px]" ref={ref}>
        ...
        <div className="lg:sticky lg:top-[120px]">
          <FadeSection>
            ...
            <h2 className="section-title">
              The Art of<br />Defining Space
            </h2>
          </FadeSection>
          <FadeSection>
            <blockquote className="font-display text-[clamp(26px,3vw,40px)] font-light italic leading-tight text-ivory my-8 lg:my-[32px_0_40px] border-l-2 border-gold pl-7">
          ...
          <FadeSection>
            <div className="grid grid-cols-2 gap-5">
              {CREDENTIALS.map((c) => (
                <div key={c.num} className="border border-rule p-[22px_24px] bg-ivory-faint">
                  <div className="font-display text-3xl lg:text-[2rem] font-light text-gold-light leading-none">{c.num}</div>
                  <div className="text-[0.62rem] tracking-[0.18em] uppercase text-ivory-dim mt-1.5">{c.label}</div>
                </div>
              ))}
            </div>
          </FadeSection>
        ...
        <div className="pt-2">
          {[
            ...
            <motion.p
              ...
              className="text-sm text-ivory-dim leading-[1.95] mb-5"
            >
              {text}
            </motion.p>
          ))}
