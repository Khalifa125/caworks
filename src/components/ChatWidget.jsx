export default function ChatWidget() {
  return (
    <div className="fixed bottom-9 right-6 md:right-9 z-200 flex flex-col items-end gap-3">
      <div className="bg-surface border border-rule px-5 py-3 flex items-center gap-2.5 shadow-[0_8px_40px_rgba(0,0,0,0.6)]">
        <span className="w-[7px] h-[7px] rounded-full bg-green-400 animate-pulse shrink-0" />
        <div>
          <div className="text-sm text-ivory font-medium tracking-[0.05em]">Menna</div>
