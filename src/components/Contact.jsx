...
export default function Contact() {
  ...
  return (
    <section className="bg-deep border-t border-rule px-6 md:px-8 lg:px-14 py-20 lg:py-[120px]" id="contact">
      <div className="max-w-[1200px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-[100px] items-center" ref={ref}>
        ...
        >
          ...
          <h2 className="section-title mb-7">Begin Your<br />Commission</h2>
          <p className="text-sm text-ivory-dim leading-[1.9] mb-12">
          ...
          <div className="flex flex-col gap-5">
            {CONTACT_DETAILS.map((d) => (
              <div key={d.label} className="flex gap-4 items-start">
                ...
                <span className="text-sm text-ivory-dim">{d.value}</span>
              </div>
            ))}
          </div>
        </motion.div>
        ...
        <motion.div
          ...
          className="bg-surface border border-rule p-[60px_52px] max-md:p-9"
        >
          <h3 className="font-display text-[1.8rem] font-light mb-2">Request a Free Consultation</h3>
          <p className="text-sm text-ivory-dim mb-9">
          ...
          <form onSubmit={(e) => e.preventDefault()}>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="form-field">
                ...
                <input type="text" placeholder="Your surname" className="form-input" />
              </div>
            </div>
            <div className="form-field">
            ...
            <div className="form-field">
              ...
              <textarea className="form-input min-h-[90px]" placeholder="Describe your space, vision, and timeline…" />
            </div>
            <button
              type="submit"
